...
2. 在 工模下打开 【Allow SUPL dedicated APN】
3. 在测试 SUPL 可以关闭 EPO 和 NPL 
      关闭EPO: 工模 > Location > YGPS > Inform ACTION >  【Enalbe EPO(Need Restart)】(disable)  【Enalbe QEPO(Need Restart)】(disable)
	  关闭NPL for SUPL:   工模 > Location > LocationEM > AGPS  >  【Use NPL Settings to SUPL】(disable)
...
04-24 13:53:41.435989  1932  4648 D AgpsApn : requestDedicatedApnAndDnsQuery() fqdn=dcm-supl.com isEsupl=false isSuplApn=true 【是否专用APN】
